...
**Your whole stack, one conversation.** An AI-powered VS Code extension that understands your entire codebase at once, not just single files. Built with Google's Gemini API.
...
2. Press `Ctrl+Shift+P` → "StoryWeaver: Analyze Entire Repository"
3. Get instant insights about your entire codebase
...
1. **Scan**: Recursively scans your workspace for supported files
2. **Context Building**: Aggregates file contents into comprehensive context
3. **AI Analysis**: Sends to Gemini with 2M token context window
4. **Structured Output**: Parses and presents insights in clean UI
